...
export async function onRequest({ request, env }) {
  ...
  // Payroll creation is exclusively handled by Data Intake. This endpoint is master-data only.
  if (body?.context) {
    return respond({
      error: 'Pembuatan Pay Run dari file hanya tersedia melalui Data Intake.',
      code: 'PAYROLL_DATA_INTAKE_REQUIRED',
    }, 409);
  }
