...
export default function DataIntakePage() {
  ...
  const [actor, setActor] = useState<{ email: string } | null>(null);
      ...
      <div className="data-intake-shell">
        <header className="data-intake-heading">
          ...
          <div className="data-intake-heading-actions">
            <a className="btn" href={PAYROLL_TEMPLATE_URL} download>
        ...
        <div className="intake-layout">
          <section className="card intake-main-card">
            ...
            >
              ...
              <div>
                <strong>{file ? file.name : "Tarik file Excel ke sini"}</strong>
                <span>
                  {file
          ...
          <aside className="card intake-guide">
            ...
            >
              ...
              <span>
                Petunjuk, contoh, dan control total tersedia di dalam workbook.
              </span>
              <b>Unduh .xlsx →</b>
            </a>
            <ul>
