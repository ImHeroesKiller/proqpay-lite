...
const VIEW_LABELS:Record<AppView,string>={dashboard:'Dashboard',operations:'Pay Runs',exceptions:'Action Center',payments:'Payment Control',billing:'Billing & AR',integrations:'Integrations',employees:'Employees',clients:'Clients & Projects',reports:'Reports',logs:'Audit Logs',ewa:'Advance Salary'};
