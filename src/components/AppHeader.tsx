...
const VIEW_LABELS:Record<AppView,string>={dashboard:'Dashboard',operations:'Pay Runs',exceptions:'Action Center',payments:'Payment Control',billing:'Billing & AR',integrations:'Integrations',employees:'Employees',clients:'Clients & Projects',reports:'Reports',logs:'Audit Logs',ewa:'Advance Salary',portalAudit:'Portal Audit',portalSettings:'Portal Settings'};
const SEARCH_ITEMS:Array<{label:string;keywords:string;view:AppView}>=[
  ...
  {label:'Portal Settings',keywords:'banner iklan ewa fee plafond tenure ess portal',view:'portalSettings'},
  {label:'Portal Audit',keywords:'login ess portal attempt ewa jejak',view:'portalAudit'},
