...
const button:any={border:0,borderRadius:8,background:'var(--accent)',color:'var(--accent-contrast)',padding:'7px 10px',fontSize:11,fontWeight:650,cursor:'pointer',whiteSpace:'nowrap'};
