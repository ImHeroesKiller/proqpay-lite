...
export default function PortalSettings() {
  const [tab, setTab] = useState<"rules" | "ads" | "copy" | "platform">(
    "rules",
  );
  ...
  const load = useCallback(
    async (nextClient: string) => {
      ...
      const query = nextClient
        ? `?clientId=${encodeURIComponent(nextClient)}`
        : "";
  ...
  async function save() {
    ...
    try {
      ...
      apply(data);
      setOk(
        "Tersimpan. Portal karyawan memakai aturan ini pada muatan berikutnya.",
      );
    } catch (error) {
  ...
  async function resetClient() {
    ...
    if (
      !window.confirm(
        "Hapus pengaturan khusus klien ini dan kembali ke default organisasi?",
      )
    )
      return;
    setBusy(true);
        ...
        >
          <label style={field}>
            ...
            <select
              ...
              onChange={(event) =>
                setPolicy({ ...policy, enabled: event.target.value === "1" })
              }
            >
          ...
          <label style={field}>
            ...
            <input
              ...
              max={100}
              step={1}
              value={Math.round(policy.maxPercent * 100)}
              onChange={(event) =>
                setPolicy({
                  ...policy,
                  maxPercent: Number(event.target.value) / 100,
                })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              ...
              max={50}
              step={0.1}
              value={Number((policy.feeRate * 100).toFixed(2))}
              onChange={(event) =>
                setPolicy({
                  ...policy,
                  feeRate: Number(event.target.value) / 100,
                })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              ...
              onChange={(event) =>
                setPolicy({
                  ...policy,
                  minFee: Number(event.target.value) || 0,
                })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              ...
              min={0}
              step={10000}
              value={policy.minFeeAmount}
              onChange={(event) =>
                setPolicy({
                  ...policy,
                  minFeeAmount: Number(event.target.value) || 0,
                })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              ...
              min={0}
              max={31}
              value={policy.minDaysWorked}
              onChange={(event) =>
                setPolicy({
                  ...policy,
                  minDaysWorked: Number(event.target.value) || 0,
                })
              }
            />
                ...
                onChange={(event) => {
                  ...
                  setPolicy(
                    unit === "days"
                      ? {
                          ...policy,
                          minTenureDays: policy.minTenureDays || 10,
                          minTenureMonths: 0,
                        }
                      : {
                          ...policy,
                          minTenureMonths: policy.minTenureMonths || 1,
                          minTenureDays: 0,
                        },
                  );
                }}
          ...
          <label style={field}>
            ...
            <input
              ...
              min={1}
              max={6}
              value={policy.maxTenorMonths}
              onChange={(event) =>
                setPolicy({
                  ...policy,
                  maxTenorMonths: Number(event.target.value) || 1,
                })
              }
            />
          </label>
          ...
          >
            ...
            {IDR.format(policy.minFeeAmount)}). Plafond dan fee dihitung di
            server, bukan di LLM. Masa kerja dihitung dari tanggal bergabung di
            kontrak.
          </p>
        </div>
      ) : null}
        ...
        <div>
              ...
              >
                ...
                <span style={{ display: "flex", gap: 6 }}>
                  <button
                    ...
                    className="btn"
                    disabled={index === 0}
                    onClick={() => setAds(move(ads, index, -1))}
                  >
                    Naik
                  </button>
                  <button
                  ...
                  <button
                    type="button"
                    className="btn"
                    onClick={() => setAds(ads.filter((_, i) => i !== index))}
                  >
                    Hapus
                  </button>
                </span>
              ...
              >
                <label style={field}>
                  ...
                  <input
                    value={ad.tag}
                    onChange={(event) =>
                      patchAd(setAds, ads, index, { tag: event.target.value })
                    }
                  />
                </label>
                <label style={field}>
                  ...
                  <input
                    value={ad.title}
                    onChange={(event) =>
                      patchAd(setAds, ads, index, { title: event.target.value })
                    }
                  />
                </label>
                <label style={field}>
                  ...
                  <input
                    value={ad.cta}
                    onChange={(event) =>
                      patchAd(setAds, ads, index, { cta: event.target.value })
                    }
                  />
                </label>
                <label style={field}>
                ...
                <label style={{ ...field, gridColumn: "1 / -1" }}>
                  ...
                  <textarea
                    ...
                    rows={2}
                    onChange={(event) =>
                      patchAd(setAds, ads, index, { desc: event.target.value })
                    }
                  />
                </label>
                {ad.action === "EXTERNAL" ? (
          ...
          {ads.length < 8 ? (
            <button
              ...
              className="btn"
              onClick={() =>
                setAds([...ads, { ...EMPTY_AD, sortOrder: ads.length }])
              }
            >
              Tambah banner
            </button>
        ...
        <div className="card" style={{ display: "grid", gap: 12, padding: 18 }}>
          <label style={field}>
            ...
            <input
              ...
              onChange={(event) =>
                setCopy({ ...copy, companyTagline: event.target.value })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              ...
              onChange={(event) =>
                setCopy({ ...copy, heroSubtitle: event.target.value })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              value={copy.ewaTitle}
              onChange={(event) =>
                setCopy({ ...copy, ewaTitle: event.target.value })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              ...
              onChange={(event) =>
                setCopy({ ...copy, ewaSubtitle: event.target.value })
              }
            />
          </label>
          <label style={field}>
            ...
            <textarea
              ...
              value={copy.ewaBody}
              onChange={(event) =>
                setCopy({ ...copy, ewaBody: event.target.value })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              value={copy.ewaCta}
              onChange={(event) =>
                setCopy({ ...copy, ewaCta: event.target.value })
              }
            />
          </label>
          <label style={field}>
            ...
            <input
              ...
              onChange={(event) =>
                setCopy({ ...copy, ewaLimitCaption: event.target.value })
              }
            />
          </label>
        </div>
        ...
        >
          ...
          <label style={field}>
            ...
            <select
              ...
              onChange={(event) =>
                setPlatform({ ...platform, provider: event.target.value })
              }
            >
              <option value="NONE">Tidak ada</option>
              <option value="GENERIC">Pixel URL sendiri</option>
              <option value="GOOGLE_ADS">
                Google Ads (conversion noscript)
              </option>
            ...
            <>
              <label style={field}>
                ...
                <input
                  ...
                  onChange={(event) =>
                    setPlatform({ ...platform, accountId: event.target.value })
                  }
                />
              </label>
              <label style={field}>
                ...
                <input
                  ...
                  onChange={(event) =>
                    setPlatform({
                      ...platform,
                      conversionLabel: event.target.value,
                    })
                  }
                />
              </label>
          ...
          {platform.provider === "META" ? (
            <label style={field}>
              ...
              <input
                ...
                onChange={(event) =>
                  setPlatform({ ...platform, pixelId: event.target.value })
                }
              />
            </label>
          ) : null}
