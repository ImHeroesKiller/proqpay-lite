          ...
          <main className="settings-content" ref={contentRef}>
            ...
            {tab === 'appearance' ? <>
              <SettingsSection title="Tema & navigasi" description="Pilih kontras, warna aksen, dan bentuk sidebar.">
                <div className="settings-form-grid">
                  <Field label="Tema"><select value={settings.theme} onChange={(event) => patch({ theme: event.target.value as AppSettings['theme'] })}><option value="light">Premium light</option><option value="soft">Soft canvas</option><option value="dark">Professional dark</option><option value="contrast">High contrast</option></select></Field>
